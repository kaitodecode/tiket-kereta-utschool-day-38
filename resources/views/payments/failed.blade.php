    ...
    <style>
        ...
        body::before {
            ...
            background: 
                ...
                radial-gradient(circle at 90% 80%, rgba(255, 77, 90, 0.1) 0%, transparent 50%);
            z-index: -1;
        }
            ...
            <div class="col-md-6 text-center">
                <div class="card shadow">
                    <div class="card-body py-5">
                        ...
                        <h2 class="mt-3 text-highlight">Payment Failed!</h2>
                        <p class="lead mb-4">We're sorry, but your transaction could not be completed at this time.</p>
                        <div class="mt-4">
